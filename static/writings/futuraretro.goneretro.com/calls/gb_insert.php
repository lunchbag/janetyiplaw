...
$connection=mysql_connect("localhost", "futurare_me", "mi") or die ('Cannot connect because: ' . mysql_error());
...
$sql="INSERT INTO gb VALUES ('$gbname', '$gbemail', '$gbemailhide', '$gburl', '$gbmsg', '$gbdate')";
